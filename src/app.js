...
function addRemoveClass(key,state)
{
  var element = document.querySelector(".btn-"+key)
  if(state==true)
  {
...
function renderIngredientsBoard(key,state) {
  var ingredients = document.querySelectorAll("."+key);
  if(state==true)
  {
